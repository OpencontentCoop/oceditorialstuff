...
{if $post.images}
  ...
  <div class="row">
    <div class="col-sm-12" style="margin-bottom: 10px;">
      <div class="well well-sm clearfix">
        <p class="pull-right">
          <a class="btn btn-danger btn-lg" href="{concat( '/editorialstuff/media/', $factory_identifier, '/remove/', $post.object.id, '/image/', $main_image.contentobject_id )|ezurl(no)}"><i class="fa fa-trash"></i></a>
  ...
  <div class="row"> 
    ...
    <div class="col-sm-{$col-width}" style="margin-bottom: 10px;">
      ...
      <div class="col-xs-6">
        <p>
          <a class="btn btn-danger btn-lg" href="{concat( '/editorialstuff/media/', $factory_identifier, '/remove/', $post.object.id, '/image/', $item.contentobject_id )|ezurl(no)}"><i class="fa fa-trash"></i></a>
