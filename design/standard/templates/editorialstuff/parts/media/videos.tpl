  ...
  <div class="row"> 
	...
	<div class="col-sm-{$col-width}" style="margin-bottom: 10px;">	  	 	  
      ...
      {*<small>{attribute_view_gui attribute=$item.data_map.file}</small>*}
		...
		<div class="col-xs-6">
		  <a class="btn btn-danger btn-lg" href="{concat( '/editorialstuff/media/', $factory_identifier, '/remove/', $post.object.id, '/video/', $item.contentobject_id )|ezurl(no)}"><i class="fa fa-trash"></i></a>
