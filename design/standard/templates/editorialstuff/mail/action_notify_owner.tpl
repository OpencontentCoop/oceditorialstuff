...
{if and(is_set($action_identifier), editorialstuff_has_custom_message_text($post.factory_identifier, $action_identifier))}
{editorialstuff_get_custom_message_text($post.factory_identifier, $action_identifier, $post)}
{else}
